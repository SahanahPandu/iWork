...
class VehicleChecklistDetail extends StatefulWidget {
  ...
  VehicleChecklistDetail({Key? key, required this.data}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                            ...
                            children: <Widget>[
                              Padding(
                                padding: const EdgeInsets.only(
                                    top: 20.0, bottom: 10.0, left: 22.0),
                                child: Text(
                                  fillUpVC,
                                                  ...
                                                  Container(
                                                    padding: _device
                                                        ...
                                                        : const EdgeInsets
                                                                .symmetric(
                                                            horizontal: 16.0),
                                                    height: _device.isLandscape(
                                                            context)
                                                        ? 35
                                                        : 32,
                                                    width: _device.isLandscape(
                                                            context)
                                                        ? 400
                                                        : 0,
                                                    child: TextField(
      ...
      bottomNavigationBar: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 220, vertical: 15),
        child: SizedBox(
          height: 40,
          width: 150,
