...
class ScheduleIssueMainScreenOld extends StatefulWidget {
  final Laluan? laluanData;
  final bool fromHome;
  final String issueType;

  const ScheduleIssueMainScreenOld(
      {Key? key,
      this.laluanData,
  ...
  @override
  State<ScheduleIssueMainScreenOld> createState() => _ScheduleIssueMainScreen();
}

class _ScheduleIssueMainScreen extends State<ScheduleIssueMainScreenOld> {
  String issueTypeStr = "";
