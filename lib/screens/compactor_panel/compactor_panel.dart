  ...
  return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
    Row(children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(
          isScheduleListExist
              ? "Tugasan Hari Ini (${DateFormat("hh:mm").format(DateTime.parse('20222312 ${scheduleData!.data!.startWork!}'))} ${Time.convertAMPMToMs(scheduleData.data!.startWork!)} - ${DateFormat("hh:mm").format(DateTime.parse('20222312 ${scheduleData.data!.stopWork!}'))} ${Time.convertAMPMToMs(scheduleData.data!.stopWork!)})"
              : "Tugasan Hari ini ( --:-- )",
          style: TextStyle(
            color: white,
