...
class ReportsApi {
  ...
  static Future<ReportDetailsInfo?>? getDetailLaporan(BuildContext context, reportId) async {
  ...
  static Future<List<ReportDetailsInfo>>? getDataLaporanDrawer(BuildContext context, passData) async {
